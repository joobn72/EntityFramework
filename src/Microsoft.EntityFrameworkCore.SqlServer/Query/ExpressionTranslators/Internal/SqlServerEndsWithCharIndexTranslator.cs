    ...
    public class SqlServerEndsWithCharIndexTranslator : IMethodCallTranslator
    {
        ...
        public Expression Translate(MethodCallExpression methodCallExpression)
        {
            if (ReferenceEquals(methodCallExpression.Method, _methodInfo))
            {
                ...
                var charIndexExpression = Expression.Equal(
                    new SqlFunctionExpression(
                        "CHARINDEX", 
                        typeof(int), 
                        new[] 
                        {
                            new SqlFunctionExpression("REVERSE", patternExpression.Type, new[] { patternExpression }),
                            new SqlFunctionExpression("REVERSE", patternExpression.Type, new[] { methodCallExpression.Object }),
                        }),
